 ...
 */
final class Version20200526132129 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cms_trip CHANGE route_id route_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE transport_id transport_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE driver_id driver_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
