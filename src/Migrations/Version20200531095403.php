 ...
 */
final class Version20200531095403 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trip_costs_data (trip_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', costs_data_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_2E282B27A5BC2E0E (trip_id), INDEX IDX_2E282B2791587243 (costs_data_id), PRIMARY KEY(trip_id, costs_data_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE options_trips_costs_data (trip_id CHAR(36) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\', costs_data_id CHAR(36) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\', INDEX IDX_4EC42C4991587243 (costs_data_id), INDEX IDX_4EC42C49A5BC2E0E (trip_id), PRIMARY KEY(trip_id, costs_data_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
