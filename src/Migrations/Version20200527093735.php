 ...
 */
final class Version20200527093735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B1C05846989D9B62 ON cms_trip');
        $this->addSql('ALTER TABLE cms_trip ADD number INT NOT NULL, DROP title, DROP slug, CHANGE route_id route_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE transport_id transport_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE driver_id driver_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
